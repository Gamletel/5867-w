...
class MainBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'main-block',
				'title'             => 'Блок: Главный блок',
				'description'       => 'Главный блок с товарами',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/main-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/main-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
